...
# Loading Data and schema from a Static dJSON String url
...
def chart(request):
    ...
    timeSeries.AddAttribute("yAxis", """[{
											plot: [{
											  value: 'Time spent of exercises',
											  connectNullData: true
											}],
											min: '3',
											max: '6',
											title: 'Time spent of exercises'
										  }, {
											plot: [{
											  value: 'No. of sessions',
											  connectNullData: true
											}],
											min: '18',
											max: '30',
